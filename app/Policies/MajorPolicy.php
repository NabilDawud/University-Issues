...
class MajorPolicy
{
    ...
    {
        return $user->can('Show Major') || $user->id === $major->user_id;
    }
    ...
    {
        return $user->can('Edit Major') || $user->id === $major->user_id;
    }
    ...
    {
        return $user->can('Delete Major') && $user->id !== $major->user_id;
    }
