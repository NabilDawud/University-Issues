     ...
     <div class="row g-3">
         ...
         <div class="col-md-4">
             ...
             <select class="form-select" id="city" name="city">
                 ...
                 <option value="khan_younis" {{ ($employee->city ?? '') === 'khan_younis' ? 'selected' : '' }}>
                     Khan Younis (خانيونس)
                 </option>
                 ...
                 <option value="deir_al_balah" {{ ($employee->city ?? '') === 'deir_al_balah' ? 'selected' : '' }}>
         ...
         @isset($employee->profile_image)
             <div class="col-md-4">
                 ...
                 <div>
                     <img src="{{ asset($employee->profile_image) }}" alt="Current Profile Image" class="img-thumbnail"
