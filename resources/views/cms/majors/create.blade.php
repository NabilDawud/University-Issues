...
@section('main-title', 'Create Major')

@section('sub-title', 'create major')
    ...
    <div class="col-lg-12">
        <div class="card card-info card-outline mb-4">
            <div class="card-header">
                <div class="card-title">Create Major</div>
            </div>
            <form class="ajax-form" action="{{ route('admin.majors.store') }}" method="POST" novalidate>
